            ...
            <div class="container" style="margin-top: 50px;">
                <div class="row" style="margin-left:40px;">
                    <div class="col-md-4" style="width:300px; margin-right:50px;">
                        <img class="umbra" src="images/240_1.jpg" style="width: 300px;margin-top: 30px;">
                        <h5 id="text">MILESTONE</h5>
                        <p class="title">Taleb school system tracking 8000 students</p>
                        <p id="description">In hac habitasse platea dictumst. Vivamus adipiscing farmentum quam volutpat aliquam...</p>

                    </div>
                    <div class="col-md-4" style="width:300px; margin-right:50px;">
                        <img class="umbra" src="images/240_2.jpg" style="width: 300px;margin-top: 30px;">
                        <h5 id="text">MILESTONE</h5>
                        <p class="title">Alcochem applying vision technology to count flies demo</p>
                        <p id="description">Curabitur lobortis id lorem id bibemdum. Ut id consectetur magna. Quisque volutpat...</p>
                    </div>
                    <div class="col-md-4" style="width:300px;margin-right:50px;">
                        <img class="umbra" src="images/240_3.jpg" style="width: 300px;margin-top: 30px;">
                        <h5 id="text">REFLOW LABS</h5>
                        <p class="title">Indoor location services for wayfinding hospital</p>
                        <p id="description">Vestibulum retrum quam vitae fringilla tincidunt. Suspendisse nec tortor urna. Ut laoreet sod...</p>
                    </div> 
                </div>
            </div>
        </div>
        ...
        <div class='container-fluid' style="padding:0;">
            <div class="blue-banner">
                <p class="paragraf">Check how we can kickstart your smart projects
                    <a href="admin.php"><img class="sageata" src="images/arrow.svg" alt="arrow"></a>
                </p>
            </div>
        </div>
        <!--AICI COMPLETEAZA CODUL--> 
